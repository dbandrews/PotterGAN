"""
WGAN Code from Generative Deep Learning by David Foster:
https://github.com/davidADSP/GDL_code/blob/master/models/WGANGP.py
...
class WGANGP:
    ...
    def _build_critic(self):
        ...
        critic_output = Dense(1, activation=None, kernel_initializer=self.weight_init)(
            x
        )
